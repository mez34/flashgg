...
namespace flashgg {
    ...
    class MonoHTagProducer : public EDProducer
    {

    public:
        typedef math::XYZPoint Point;

        MonoHTagProducer( const ParameterSet & );
    private:
    ...
    MonoHTagProducer::MonoHTagProducer( const ParameterSet &iConfig ) :
        ...
        systLabel_( iConfig.getParameter<string> ( "SystLabel" ) )
    {
        ...
        produces<vector<MonoHTag> >();
        produces<vector<TagTruthBase> >();
    }

    void MonoHTagProducer::produce( Event &evt, const EventSetup & )
    {
        ...
        std::auto_ptr<vector<MonoHTag> > vhettags( new vector<MonoHTag> );
...
typedef flashgg::MonoHTagProducer FlashggMonoHTagProducer;
DEFINE_FWK_MODULE( FlashggMonoHTagProducer );
// Local Variables:
// mode:c++
